...
return [
    ...
    'connection' => [
        /**
         * Connexion mysql
         * FIX: connection not used in `vendor/bowphp/framework/src/Database/Connection/Adapter/MysqlAdapter.php`
         */
        'mysql' => [
            'hostname' => app_env('MYSQL_HOSTNAME', 'localhost'),
            'username' => app_env('MYSQL_USERNAME', 'cakephp_dbuser'),
            'password' => app_env('MYSQL_PASSWORD', 'YTgvhljkuj@$56'),
            'database' => app_env('MYSQL_DBNAME', 'cake_cms'),
